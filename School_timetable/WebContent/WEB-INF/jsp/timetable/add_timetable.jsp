...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#insert_button").click(function(){
			document.insert_timeTable.action = '<%=cp%>/timeTable/insert_timeTable.do';
		    document.insert_timeTable.submit();
		});
...
<div data-role="header" style="background-color: #6d92c6; color: #fff; margin-bottom: 1em;">
  ...
  <div data-role="footer" data-position="fixed" style="text-align: center;">
	  <input type="button" value="등 록" id="insert_button">
  </div>
	...
	<form role="form" method="post" id="insert_timeTable" name="insert_timeTable">
		...
		<input type="hidden" value="${sessionScope.sessionData.memberInfo.getMember_no()}" name="member_no" id="member_no">
	  	...
	  	<c:forEach begin="1" end="60" step="1" varStatus="status">
	  		<input type="hidden" value="" id="content_${status.index}" name="content_${status.index}">
	  	</c:forEach>
  	</form>
